...
- **Must merge together (same lines):** Branch 3 (G-1a + R-1 + R-2 — constraint satisfied: implemented together in this branch), Branch 1 (G-5 + F-1), Branch 5 (R-4 + F-3). Do not split these into per-item PRs.
